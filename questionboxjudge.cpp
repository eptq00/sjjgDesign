...
#include "ui_questionboxjudge.h"
#include <QFile>
#include <QTextStream>
#include <QString>
#include <QRandomGenerator>

questionBoxJudge::questionBoxJudge(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::questionBoxJudge)
{
    ui->setupUi(this);
    setWindowTitle("判断提问箱"); // 设置题目名称
    setWindowFlags(windowFlags() & ~Qt::WindowCloseButtonHint);
    setWindowFlags(windowFlags() & ~Qt::WindowMaximizeButtonHint);
    setWindowFlags(windowFlags() & ~Qt::WindowMinimizeButtonHint);
}

questionBoxJudge::~questionBoxJudge()
{
    delete ui;
}

void questionBoxJudge::createJudgeQuestion() {
...
void questionBoxJudge::setQuestion(){
    this->ui->questionLabel->setText(question);
}

bool questionBoxJudge::judgeJudge(){
